        ...
        <div className="overflow-x-auto">
          <div className="min-w-[520px]">
            <div className="grid grid-cols-12 gap-3 border-b border-border bg-soft px-5 py-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              <div className="col-span-1 whitespace-nowrap">#</div>
              <div className="col-span-5 whitespace-nowrap">User</div>
              <div className="col-span-2 whitespace-nowrap text-right">Reported</div>
              <div className="col-span-2 whitespace-nowrap text-right">Solved</div>
              <div className="col-span-2 whitespace-nowrap text-right">Points</div>
            </div>
              ...
              board.map((row, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="grid grid-cols-12 items-center gap-3 border-b border-border/60 px-5 py-4 text-xs last:border-b-0 hover:bg-accent/40 sm:text-sm"
                  >
                    <div className="col-span-1 flex items-center gap-1 font-display text-sm font-bold text-muted-foreground sm:text-base">
                      {i + 1}
                      {t && <t.icon className={`h-4 w-4 shrink-0 ${t.cls}`} />}
                    </div>
                    <div className="col-span-5 flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="truncate text-sm font-medium sm:text-base">{row.name}</div>
                    ...
                    <div className="col-span-2 text-right font-display text-sm font-bold text-primary sm:text-lg">{row.points}</div>
                  </motion.div>
                );
              })
            )}
